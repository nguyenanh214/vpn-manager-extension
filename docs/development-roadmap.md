...
## Phase 10 — Trừu tượng hoá OS — ✅ Hoàn thành
`platform.js` gom mọi khác biệt Linux/macOS/Windows: thư mục state, thư mục manifest
(Windows dùng registry), nơi dò node, tên file launcher, có NetworkManager hay không.
